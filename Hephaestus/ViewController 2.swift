...
class ViewController: NSViewController {
    ...
    @IBAction func ActionStart(_ sender: Any) {
        ...
        if !bootstrapResourceInstalled() {
            ...
            println("rwx@rootfs confirmed.")
            println("Downloading netlive...")
            System.download(address: "https://raw.githubusercontent.com/HTTP410GONE/MacintoshPackager/master/net-live", output: System.getHomeDirectory() + "netlive", doSU: false, password: nil)
